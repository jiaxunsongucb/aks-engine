...
AZUREBLOB_CSI_VERSIONS="
0.10.0
"
for AZUREBLOB_CSI_VERSION in ${AZUREBLOB_CSI_VERSIONS}; do
  CONTAINER_IMAGE="mcr.microsoft.com/k8s/csi/blob-csi:v${AZUREBLOB_CSI_VERSION}"
  pullContainerImage "docker" ${CONTAINER_IMAGE}
  echo "  - ${CONTAINER_IMAGE}" >> ${VHD_LOGS_FILEPATH}
done
